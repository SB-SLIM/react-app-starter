    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="relative overflow-hidden px-4 py-14 text-center sm:px-6 sm:py-24 lg:py-36">
        <div className="pointer-events-none absolute inset-0 flex items-start justify-center">
          <div className="h-[400px] w-full max-w-3xl translate-y-[-30%] rounded-full bg-indigo-600/10 blur-3xl sm:h-[500px]" />
        </div>

        <div className="relative mx-auto max-w-4xl">
          <Badge
            variant="outline"
            className="mb-5 border-indigo-500/30 bg-indigo-500/5 text-indigo-400 sm:mb-6"
          >
          ...
          <h1 className="text-3xl font-black leading-tight tracking-tight sm:text-5xl lg:text-7xl">
            The SaaS starter kit that{' '}
            <span className="bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400 bg-clip-text text-transparent">
              ships everything.
            </span>
          </h1>

          <p className="mx-auto mt-5 max-w-xl text-sm text-zinc-400 sm:mt-6 sm:text-lg">
          ...
          {/* Terminal */}
          <div className="mx-auto mt-10 overflow-hidden rounded-xl border border-white/10 bg-zinc-900 text-left shadow-2xl sm:mt-12 sm:max-w-lg">
            <div className="flex items-center gap-1.5 border-b border-white/5 px-4 py-3">
              <span className="h-2.5 w-2.5 rounded-full bg-red-500" />
              <span className="h-2.5 w-2.5 rounded-full bg-yellow-500" />
              <span className="h-2.5 w-2.5 rounded-full bg-green-500" />
            </div>
            <div className="overflow-x-auto px-5 py-4 font-mono text-xs sm:text-sm">
      ...
      <section
        id="features"
        className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-24"
      >
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 sm:mt-10 lg:grid-cols-4">
          {features.map((f) => (
            <div
              key={f.title}
              className="rounded-xl border border-white/8 bg-white/[0.02] p-5 transition-colors hover:border-indigo-500/40 sm:p-6"
            >
              <div
      ...
      <section
        id="stack"
        className="bg-white/[0.015] px-4 py-12 sm:px-6 sm:py-24"
      >
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 sm:mt-12 sm:grid-cols-4 sm:gap-8">
            {stack.map((group) => (
              <div key={group.heading}>
                <h4 className="mb-3 text-xs font-bold uppercase tracking-widest text-zinc-600 sm:mb-4">
                  {group.heading}
                </h4>
      ...
      {/* ── QUICK START / CTA ── */}
      <section className="relative overflow-hidden px-4 py-14 text-center sm:px-6 sm:py-28">
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="h-[300px] w-full max-w-xl rounded-full bg-indigo-600/8 blur-3xl sm:h-[400px]" />
        </div>
        ...
        <div className="relative mx-auto max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">
            One command.{' '}
            <span className="block sm:inline">Your full SaaS stack.</span>
          </h2>
          <p className="mx-auto mt-4 max-w-md text-sm text-zinc-400 sm:text-base">
            Bootstrap a new project with plugins from npm — no{' '}
            <code className="rounded bg-zinc-800 px-1.5 py-0.5 text-xs text-zinc-300 sm:text-sm">
              packages/
            </code>{' '}
            to maintain.
          </p>

          <div className="mx-auto mt-8 overflow-hidden rounded-xl border border-white/10 bg-zinc-900 text-left shadow-2xl sm:mt-10 sm:max-w-md">
            <div className="overflow-x-auto px-5 py-4 font-mono text-xs sm:text-sm">
              <p className="whitespace-nowrap text-zinc-500">
                ${' '}
                <span className="text-cyan-300">
              ...
              <p className="mt-2 whitespace-nowrap text-zinc-500">
